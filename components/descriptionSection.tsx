...
export default function DescriptionSection() {
    ...
    <a href="#" className="link" target="_self">
        <p>Максимизируйте свой бизнес-потенциал в Интернете </p>
                    ...
                    <div className="home-elem-49"><span className="home-elem-48"> <Image width={500} height={500}
                                                                                         alt="a"
        ...
        <p>Настраиваемые функции для уникальных бизнес-потребностей </p>
                    ...
                    <div className="home-elem-46"><span className="home-elem-45"> <Image width={500} height={500}
                                                                                         alt="a"
        ...
        <p>Передовые технологии и круглосуточная поддержка</p>
                ...
                <div className="home-elem-56">
                    <div className="home-elem-55"><span className="home-elem-54"> <Image width={500} height={500}
                                                                                         alt="a"
